                    ...
                    <div className="row featurette d-flex  justify-content-center align-items-center mx-auto my-3">
                        <div className="col-md-7 ">
                            <h2 className="featurette-heading textColor">
                                <p>Hello, I'm Umer Yasir<br /></p>
                                <span className="text-warning">
                                    {currentText}
                                </span>
                            </h2>
                            <p className="lead textColor">I am a Student of BS Software Engineering currently
    working as a Full Stack Developer. Insha'Allah in the future I will move
    toward Data Science.
                            </p>
                            <div className="ref ">
                                <button type="button" className="btn btn-outline-warning bg-light">
                                    <Link to="https://github.com/UmerYasir718"><i className="fa-brands fa-github" style={{ color: "#212529" }}></i>
                                    </Link>
                                </button>&nbsp;
                                <button type="button" className="btn btn-outline-warning bg-light">
                                    <Link to="http://www.linkedin.com/in/umer-yasir718"><i className="fa-brands fa-linkedin-in" style={{ color: "#212529" }}></i>
                                    </Link>
                                </button>&nbsp;
                                <button type="button" className="btn btn-outline-warning bg-light">
                                    <Link to="mailto:umer_yasir_718"><i className="fa-solid fa-g" style={{ color: "#212529" }}></i>
                                    </Link>
                                </button>&nbsp;
                                <button type="button" className="btn btn-outline-warning bg-light">
                                    <Link to="https://www.facebook.com/umer.yasir.927?mibextid=ZbWKwL"><i className="fa-brands fa-facebook" style={{ color: "#212529" }}></i>
                                    </Link>
                                </button><br /><br />
                                <div className="d-grid gap-2 d-md-block">
                                    <button type="button" className="btn btn-warning ">
                                        <Link className="text-dark fw-bold " to="https://github.com/UmerYasir718">
                                    ...
                                    &nbsp;
                                    <button type="button" className="btn btn-warning ">
                                        <Link className="text-dark fw-bold " to="CV/Umer_Yasir_CV.pdf" download="Umer_Yasir_CV.pdf"><i className="fa-solid fa-download" style={{ color: "#212529" }}></i>
                                            Download Resume
                                        </Link>
                                    </button>
                                </div>
                        ...
                        <div className="col-md-5 my-4 Picture">
                            <img className="bd-placeholder-img bd-placeholder-img-sm featurette-image img-fluid mx-auto rounded Picture" width="500" height="500" src="./Pics/best.png" alt="" />
                        </div>
                    </div>
                </div >
            </div>
