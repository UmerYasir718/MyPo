          ...
          <div className="row featurette my-3">
            <div className="col-md-6">
              <h5 className="textColor">
                I am a Student of BSc Software Engineering.I am Expert in desgin
                Web Pages with Outstanding Graphic, Color, and decent interface.
                Work Experience with two international company and currently
                work as Freelance. Ability to do work in less time with more
                accuracy.
              </h5>
            </div>
            <div className="col-md-6">
              <div className="text-warning font-weight-bold">
                Age<span className="textColor"> ➤ 19</span>
              </div>
              &nbsp;
              <div className="text-warning font-weight-bold">
              ...
              &nbsp;
              <div className="text-warning font-weight-bold">
                E-mail<span className="textColor"> ➤ umer718@gmail.com</span>
              </div>
              &nbsp;
              <div className="text-warning font-weight-bold">
                Phone<span className="textColor"> ➤ +92 3314911420</span>
              </div>
            </div>
          </div>
        </div>
