          ...
          <div className="col-8 col-12 col-sm-12 col-md-8 order-1 order-md-1 order-sm-1">
            ...
            <div className="row">
              ...
              <div className="col-8 textColor font-weight-light">
                <span className="heading font-weight-bold">
                  <b> FSc Pre- Engineering</b>
                </span>
                <br />
                Studying FSc Pre-Engineering at Aspire Group of Colleges lays a
                strong academic foundation for students pursuing engineering
            ...
            <div className="row">
              ...
              <div className="col-8 font-weight-light">
                ...
                <br />
                Studying at Deen Public High School during my secondary
