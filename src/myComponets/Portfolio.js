...
import { Link } from "react-router-dom";
import Navbar from "./Navbar";
import ToDo from "../Gifs/ToDo_List.gif";
import Final_project from "../Gifs/Final_project.gif";
import Converter from "../Gifs/conveter.gif";
import Portfolio_Interfaces from "../Gifs/Portfolio_Interfaces.gif";
import HtmlPages from "../Gifs/Html.gif";
import Gallery from "../Gifs/gallery.gif";
export default function Portfolio() {
  return (
    <div>
      <Navbar />
